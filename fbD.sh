...
yarn jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming*.jar \
  -mapper  /home/student/cisc_525/mapreduce-py/app/FlightsByDestinationMapper.py \
  -reducer  /home/student/cisc_525/mapreduce-py/app/FlightsByDestinationReducer.py -input $1 -output $2
